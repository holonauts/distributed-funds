...
$: name, purposeDescription, rulesDescription, timePeriod, applicationTemplate, evaluationTemplate;
...
<div style="display: flex; flex-direction: column">
  ...
  <div style="margin-bottom: 16px">
    <mwc-textarea outlined label="Purpose Description" value={ purposeDescription } on:input={e => { purposeDescription = e.target.value;} } required></mwc-textarea>          
  </div>
            
  <div style="margin-bottom: 16px">
    <mwc-textarea outlined label="Rules Description" value={ rulesDescription } on:input={e => { rulesDescription = e.target.value;} } required></mwc-textarea>          
  </div>
