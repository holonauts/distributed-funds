...
<div style="display: flex; flex-direction: column">
  ...
  <div style="display: flex; flex-direction: row; margin-bottom: 16px">
    ...
    <span style="white-space: pre-line">{ new Date(timePeriod.start_at / 1000).toLocaleString() }</span>
  </div>

  <div style="display: flex; flex-direction: row; margin-bottom: 16px">
    <span style="margin-right: 4px"><strong>End At:</strong></span>
    <span style="white-space: pre-line">{ new Date(timePeriod.end_at / 1000).toLocaleString() }</span>
  </div>
