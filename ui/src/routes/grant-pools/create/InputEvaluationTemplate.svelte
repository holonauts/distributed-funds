...
<Modal size="xl" outsideclose title="Create Evaluation Template" bind:open={showCreateModal}>
...
<Modal size="xl" outsideclose title="Select Evaluation Template" bind:open={showSelectModal}>
