    ...
    match op.flattened::<EntryTypes, LinkTypes>()? {
                ...
                OpEntry::CreateEntry { app_entry, action } => {
                    match app_entry {
                        ...
                        EntryTypes::TimePeriod(time_period) => {
                            validate_create_time_period(
                                EntryCreationAction::Create(action),
                                time_period,
                            )
                        }
                        EntryTypes::GrantPool(grant_pool) => {
                            validate_create_grant_pool(
                                EntryCreationAction::Create(action),
                                grant_pool,
                            )
                        }
            ...
            match update_entry {
                OpUpdate::Entry {
                    ...
                    match (app_entry, original_app_entry) {
                        ...
                        (
                            EntryTypes::ApplicationTemplate(application_template),
                            EntryTypes::ApplicationTemplate(
        ...
        FlatOp::RegisterCreateLink {
            ...
            match link_type {
                ...
                LinkTypes::AllEvaluationTemplates => {
                    validate_create_link_all_evaluation_templates(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::AllTimePeriods => {
                    validate_create_link_all_time_periods(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::AllGrantPools => {
                    validate_create_link_all_grant_pools(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::ApplicationUpdates => {
                    validate_create_link_application_updates(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::AllApplications => {
                    validate_create_link_all_applications(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::MyApplications => {
                    validate_create_link_my_applications(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::AgentToEvmWallet => {
                    validate_create_link_agent_to_evm_wallet(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::SponsorToGrantPool => {
                    validate_create_link_sponsor_to_grant_pool(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::GrantPoolToSponsor => {
                    validate_create_link_grant_pool_to_sponsor(
                        action,
                        base_address,
                        target_address,
                        tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            match link_type {
                ...
                LinkTypes::AllTimePeriods => {
                    validate_delete_link_all_time_periods(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::AllGrantPools => {
                    validate_delete_link_all_grant_pools(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::ApplicationUpdates => {
                    validate_delete_link_application_updates(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::AllApplications => {
                    validate_delete_link_all_applications(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::MyApplications => {
                    validate_delete_link_my_applications(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::AgentToEvmWallet => {
                    validate_delete_link_agent_to_evm_wallet(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::SponsorToGrantPool => {
                    validate_delete_link_sponsor_to_grant_pool(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::GrantPoolToSponsor => {
                    validate_delete_link_grant_pool_to_sponsor(
                        action,
                        original_action,
                        base_address,
                        target_address,
                    ...
                    match app_entry {
                        EntryTypes::ApplicationTemplate(application_template) => {
                            ...
                            if let ValidateCallbackResult::Valid = result {
                                let original_application_template: Option<
                                    ApplicationTemplate,
                                > = original_record
                                    .entry()
                                    .to_app_option()
                        ...
                        EntryTypes::EvaluationTemplate(evaluation_template) => {
                            ...
                            if let ValidateCallbackResult::Valid = result {
                                let original_evaluation_template: Option<
                                    EvaluationTemplate,
                                > = original_record
                                    .entry()
                                    .to_app_option()
                        ...
                        EntryTypes::GrantPoolOutcome(grant_pool_outcome) => {
                            ...
                            if let ValidateCallbackResult::Valid = result {
                                let original_grant_pool_outcome: Option<GrantPoolOutcome> = original_record
                                    .entry()
                                    .to_app_option()
                                    .map_err(|e| wasm_error!(e))?;
