...
pub fn validate(op: Op) -> ExternResult<ValidateCallbackResult> {
    match op.flattened::<EntryTypes, LinkTypes>()? {
        ...
        FlatOp::RegisterCreateLink {
            ...
            LinkTypes::ApplicationToEvaluations => validate_create_link_application_to_evaluations(
                action,
                base_address,
                target_address,
                tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            LinkTypes::ApplicationToEvaluations => validate_delete_link_application_to_evaluations(
                action,
                original_action,
                base_address,
                target_address,
